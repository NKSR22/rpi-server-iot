...
MQTT ย่อมาจาก Message Queuing Telemetry Transport เป็นโปรโตคอลรับส่งข้อความแบบเบา เหมาะกับอุปกรณ์ IoT ที่มีทรัพยากรจากัดหรือเครือข่ายไม่เสถียร
...
- QoS 1: ส่งอย่างน้อยหนึ่งครั้ง อาจเกิดข้อมูลซ้าได้
...
- รองรับการทางานแบบ asynchronous
...
- แยก topic คาสั่งและ topic telemetry ออกจากกัน
